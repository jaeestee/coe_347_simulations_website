...
import Amesh from './Simulations/30Va0.gif';
import Bmesh from './Simulations/30Va10.gif';
import Cmesh from './Simulations/30Va20.gif';

import { Link } from 'react-router-dom';
import { Button } from 'reactstrap';


const Vertex30: React.FC = () => {
  ...
  <div>
    ...
    <h1>Meshes with Vertex Angle of 30 Degrees</h1>
