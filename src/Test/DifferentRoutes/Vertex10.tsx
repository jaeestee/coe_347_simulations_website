...
import Amesh from './Simulations/10Va0.gif';
import Bmesh from './Simulations/10Va10.gif';
import Cmesh from './Simulations/10Va20.gif';
import { Link } from 'react-router-dom';
import { Button } from 'reactstrap';


const Vertex10: React.FC = () => {
  ...
  <div>
    ...
    <h1>Meshes with Vertex Angle of 10 Degrees</h1>
